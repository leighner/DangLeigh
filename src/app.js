   ...
   (function () {
       ...
       renderer.view.addEventListener('mousedown', function (event) {
           ...
           if (hitBodies.length) {
               ...
               if (hitBody == resume) {
                   ...
                   window.open("LeighPascoeResume.pdf");
               }
       ...
       $("#greeting").delay(1000).typed({
           strings: ["Hi.", "I'm <strong>Leigh</strong>"],
           typeSpeed: 40,
           contentType: 'html'
       }).delay(1000);
       function showAfterFirst() {
           $("#aftergreet").typed({
               strings: ["and</br> </br>I Love Code"],
               typeSpeed: 10,
               contentType: 'html'
           })
       }
       setTimeout(showAfterFirst, 3000)
